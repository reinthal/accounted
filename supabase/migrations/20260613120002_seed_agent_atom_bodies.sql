...
- `references/depreciaton.md` → `gnubok_load_skill("horizontal/swedish-asset-accounting/depreciaton")` — Depreciation Methods & Tax Rules
...
**Exception for non-VAT entities:** Threshold effectively rises by the non-deductible VAT amount since cost includes it.$gb$,
  ...
  (
    ...
    $gb${}$gb$::jsonb,
    1365,
    '.claude/skills/swedish-asset-accounting/references/depreciaton.md',
...
Sale proceeds reduce the skattemässigt restvärde directly.$gb$,
    'horizontal/swedish-asset-accounting',
    1,
    1
  ),
...
- `references/ob-overtime.md` → `gnubok_load_skill("horizontal/swedish-payroll/ob-overtime")` — Sjuklön (Sick Pay)
